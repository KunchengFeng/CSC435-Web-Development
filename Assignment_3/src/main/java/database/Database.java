...
public class Database {
    ...
    public static int create(Connection connection, Person person) {
        try {
    ...
    public static Person review(Connection connection, int id) {
        try {
    ...
    public static void update(Connection connection, Person person) {
        try {
